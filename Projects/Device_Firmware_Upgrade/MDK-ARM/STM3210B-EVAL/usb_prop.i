...
#line 31 "..\\src\\usb_prop.c"
#line 32 "..\\src\\usb_prop.c"
#line 33 "..\\src\\usb_prop.c"
...
#line 101 "..\\inc\\usb_prop.h"

 
 
 

#line 122 "..\\inc\\usb_prop.h"
...
extern  uint8_t DFU_DeviceDescriptor[18];
extern  uint8_t DFU_ConfigDescriptor[36];
extern  uint8_t DFU_StringLangId     [4];
extern  uint8_t DFU_StringVendor     [38];
extern  uint8_t DFU_StringProduct    [20];
extern  uint8_t DFU_StringSerial     [26];
extern  uint8_t DFU_StringInterface0 [98];
extern  uint8_t DFU_StringInterface1 [98];
extern  uint8_t DFU_StringInterface2_1 [106];
extern  uint8_t DFU_StringInterface2_2 [106];
extern  uint8_t DFU_StringInterface2_3 [106];
...
#line 36 "..\\src\\usb_prop.c"
#line 1 "..\\inc\\dfu_mal.h"
...
#line 73 "..\\inc\\dfu_mal.h"

 
#line 36 "..\\inc\\dfu_mal.h"
#line 37 "..\\inc\\dfu_mal.h"
...
extern uint8_t  MAL_Buffer[0x0400];  


 
#line 37 "..\\src\\usb_prop.c"
...
uint32_t Manifest_State = 0x00;
uint32_t Pointer = 0x08004000;   
...
ONE_DESCRIPTOR Config_Descriptor =
 ...
 ONE_DESCRIPTOR DFU_String_Descriptor[6] =
  ...
  {
    {       (uint8_t*)DFU_StringLangId,          4       },
    {       (uint8_t*)DFU_StringVendor,          38       },
    {       (uint8_t*)DFU_StringProduct,         20      },
    {       (uint8_t*)DFU_StringSerial,          26       },
    {       (uint8_t*)DFU_StringInterface0,      98   }

    ,
    {       (uint8_t*)DFU_StringInterface1,      98   }
#line 114 "..\\src\\usb_prop.c"
  };
...
void DFU_Reset(void)
{
  ...
  (*((volatile unsigned *)((0x40005C00L) + 0x50)) = (uint16_t)((0x00) & 0xFFF8));

   
  ((*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0))= (uint16_t)((((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0)))) & (~(0x0600) & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F)))) | (0x0200) )));
  { register uint16_t _wRegVal; _wRegVal = ((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0)))) & ((0x0030)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))); if(((0x0010) & (0x0020))!= 0) _wRegVal ^= (0x0010); if(((0x0020) & (0x0020))!= 0) _wRegVal ^= (0x0020); (*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0))= (uint16_t)(_wRegVal | (0x8000)|(0x0080))); };
  (*((uint32_t *)((((uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+((uint8_t)0)*8+4)*2 + (0x40006000L))) = (((0x10) >> 1) << 1));
  SetEPRxCount(((uint8_t)0), Device_Property.MaxPacketSize);
  (*((uint32_t *)((((uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+((uint8_t)0)*8 )*2 + (0x40006000L))) = (((0x50) >> 1) << 1));
  SetEPTxCount(((uint8_t)0), Device_Property.MaxPacketSize);
...
void DFU_Status_Out (void)
{
  ...
  if (pInfo->USBbRequest == DFU_GETSTATUS)
  {
    if (DeviceState == 4)
    {
      if (wBlockNum == 0)    
      {
        if ((MAL_Buffer[0] ==  0x00) && (wlength == 1))
        {}
        else if  (( MAL_Buffer[0] ==  0x21 ) && (wlength == 5))
        {
        ...
        else if (( MAL_Buffer[0] ==  0x41 ) && (wlength == 5))
        {
          Pointer  = MAL_Buffer[1];
          Pointer += MAL_Buffer[2] << 8;
          Pointer += MAL_Buffer[3] << 16;
      ...
      {
        Addr = ((wBlockNum - 2) * 0x0400) + Pointer;
...
RESULT DFU_Data_Setup(uint8_t RequestNo)
{
  ...
  {
    if (RequestNo == DFU_UPLOAD && (DeviceState == 2
                                    || DeviceState == 9 ))
    {
      CopyRoutine = UPLOAD;
    }
    else if (RequestNo == DFU_DNLOAD && (DeviceState == 2
                                         || DeviceState == 5))
    {
      DeviceState = 3;
      CopyRoutine = DNLOAD;
...
RESULT DFU_NoData_Setup(uint8_t RequestNo)
{
  ...
  if ((pInformation->USBbmRequestType & (0x60 | 0x1F)) == (0x20 | INTERFACE_RECIPIENT))
  {
    ...
    if (RequestNo == DFU_DNLOAD)
    {
      ...
      if (DeviceState == 5 || DeviceState == 2 )
      {
        Manifest_State = 0x01;
        DeviceState = 6;
        DeviceStatus[1] = 0;
  ...
  switch (DeviceState)
  {
    case   3:
      if (wlength != 0)
      {
        DeviceState = 4;
        DeviceStatus[4] = DeviceState;
        if ((wBlockNum == 0) && (MAL_Buffer[0] == 0x41))
        {
    ...
    case   6 :
      ...
      else if (Manifest_State == 0x00 && Config_Descriptor.Descriptor[20]
               & 0x04)
      {
        DeviceState = 2;
        DeviceStatus[4] = DeviceState;
...
void DFU_write_crc(void)
{
  ...
  else
  {
    ...
    BKP_WriteBackupRegister(((uint16_t)0x0004), 0x0000);
    ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR &= ~((uint16_t)0x0100);
