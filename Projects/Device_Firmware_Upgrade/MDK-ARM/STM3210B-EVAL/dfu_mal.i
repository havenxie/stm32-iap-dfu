...
#line 33 "..\\src\\dfu_mal.c"
#line 34 "..\\src\\dfu_mal.c"
#line 35 "..\\src\\dfu_mal.c"
#line 1 "..\\inc\\flash_if.h"
...
#line 36 "..\\src\\dfu_mal.c"

#line 39 "..\\src\\dfu_mal.c"

#line 41 "..\\src\\dfu_mal.c"
#line 42 "..\\src\\dfu_mal.c"
...
uint16_t MAL_Erase(uint32_t SectorAddress)
{
  ...
  switch (SectorAddress & 0xFC000000)
  {
    case 0x08000000:
...
#line 247 "..\\src\\dfu_mal.c"
  
  buffer[1] = (uint8_t)((TimingTable[x][y])&0xFF); buffer[2] = (uint8_t)(((TimingTable[x][y])&0xFF00)>>8); buffer[3] = (uint8_t)(((TimingTable[x][y])&0xFF0000)>>16);;   
