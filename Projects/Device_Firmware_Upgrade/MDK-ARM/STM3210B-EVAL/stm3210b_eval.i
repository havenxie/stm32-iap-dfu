...
#line 34 "..\\..\\..\\Utilities\\STM32_EVAL\\STM3210B_EVAL\\stm3210b_eval.c"
...
#line 35 "..\\..\\..\\Utilities\\STM32_EVAL\\STM3210B_EVAL\\stm3210b_eval.c"
...
GPIO_TypeDef* GPIO_PORT[4] = {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),
                                 ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))};
const uint16_t GPIO_PIN[4] = {((uint16_t)0x0200), ((uint16_t)0x0080), ((uint16_t)0x0100),
                                 ((uint16_t)0x0200)};
const uint32_t GPIO_CLK[4] = {((uint32_t)0x00000004), ((uint32_t)0x00000010), ((uint32_t)0x00000010),
                                 ((uint32_t)0x00000010)};

GPIO_TypeDef* BUTTON_PORT[8] = {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), 
                                      ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),
                                      ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400)),
                                      ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400))}; 

const uint16_t BUTTON_PIN[8] = {((uint16_t)0x0001), ((uint16_t)0x8000), 
                                      ((uint16_t)0x0200), ((uint16_t)0x0001),
                                      ((uint16_t)0x0002), ((uint16_t)0x0100),
                                      ((uint16_t)0x4000), ((uint16_t)0x1000)}; 

const uint32_t BUTTON_CLK[8] = {((uint32_t)0x00000004), ((uint32_t)0x00000008),
                                      ((uint32_t)0x00000008), ((uint32_t)0x00000040),
                                      ((uint32_t)0x00000040), ((uint32_t)0x00000020),
                                      ((uint32_t)0x00000020), ((uint32_t)0x00000020)};
...
const uint16_t BUTTON_IRQn[8] = {EXTI0_IRQn, EXTI15_10_IRQn, 
                                       EXTI9_5_IRQn, EXTI0_IRQn,
                                       EXTI1_IRQn, EXTI9_5_IRQn,
...
GPIO_TypeDef* COM_TX_PORT[2] = {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400))};
 
GPIO_TypeDef* COM_RX_PORT[2] = {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400))};
 
const uint32_t COM_USART_CLK[2] = {((uint32_t)0x00004000), ((uint32_t)0x00020000)};

const uint32_t COM_TX_PORT_CLK[2] = {((uint32_t)0x00000004), ((uint32_t)0x00000020)};
 
const uint32_t COM_RX_PORT_CLK[2] = {((uint32_t)0x00000004), ((uint32_t)0x00000020)};

const uint16_t COM_TX_PIN[2] = {((uint16_t)0x0200), ((uint16_t)0x0020)};

const uint16_t COM_RX_PIN[2] = {((uint16_t)0x0400), ((uint16_t)0x0040)};
...
void STM_EVAL_COMInit(COM_TypeDef COM, USART_InitTypeDef* USART_InitStruct)
{
  ...
  else
  {
    ...
    GPIO_PinRemapConfig(((uint32_t)0x00000008), ENABLE);
...
void SD_LowLevel_Init(void)
{
  ...
  RCC_APB2PeriphClockCmd(((uint32_t)0x00000010) | ((uint32_t)0x00000004) | ((uint32_t)0x00000004) |
                         ((uint32_t)0x00000004) | ((uint32_t)0x00000040), ENABLE);
...
void sFLASH_LowLevel_Init(void)
{
  ...
  RCC_APB2PeriphClockCmd(((uint32_t)0x00000004) | ((uint32_t)0x00000004) | ((uint32_t)0x00000004) |
