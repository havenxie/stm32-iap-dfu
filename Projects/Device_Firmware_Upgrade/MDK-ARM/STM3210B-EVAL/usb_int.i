...
#line 30 "..\\..\\..\\Libraries\\STM32_USB-FS-Device_Driver\\src\\usb_int.c"
...
void CTR_LP(void)
{
  ...
  while (((wIstr = ((uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x44)))) & (0x8000)) != 0)
  {
    ...
    if (EPindex == 0)
    {
	    ...
	    SaveRState = ((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0))));
	    SaveTState = SaveRState & (0x0030);
	    SaveRState &=  (0x3000);	

	    { register uint32_t _wRegVal; _wRegVal = ((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0)))) & (((0x3000)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))) |(0x0030)) ; if(((0x1000) & (0x2000))!= 0) _wRegVal ^= (0x1000); if(((0x2000) & (0x2000))!= 0) _wRegVal ^= (0x2000); if(((0x0010) & (0x0020))!= 0) _wRegVal ^= (0x0010); if(((0x0020) & (0x0020))!= 0) _wRegVal ^= (0x0020); (*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0))= (uint16_t)_wRegVal | (0x8000)|(0x0080)); };
      ...
      if ((wIstr & (0x0010)) == 0)
      {
        ...
        In0_Process();
            ...
            { register uint32_t _wRegVal; _wRegVal = ((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0)))) & (((0x3000)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))) |(0x0030)) ; if(((0x1000) & SaveRState)!= 0) _wRegVal ^= (0x1000); if(((0x2000) & SaveRState)!= 0) _wRegVal ^= (0x2000); if(((0x0010) & SaveTState)!= 0) _wRegVal ^= (0x0010); if(((0x0020) & SaveTState)!= 0) _wRegVal ^= (0x0020); (*(((volatile unsigned *)((0x40005C00L))) + ((uint8_t)0))= (uint16_t)_wRegVal | (0x8000)|(0x0080)); };
		  return;
      }
      else
      {
