...
#line 33 "..\\src\\usb_istr.c"
#line 1 "..\\inc\\usb_istr.h"
...
void USB_Istr(void)
{
 ...
 volatile uint32_t EP[8];
  ...
  wIstr = ((uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x44)));
...
#line 116 "..\\src\\usb_istr.c"
   

  if (wIstr & (0x2000) & wInterrupt_Mask)
  {
    (*((volatile unsigned *)((0x40005C00L) + 0x44)) = (uint16_t)(uint16_t)(~(0x2000)));
  ...
  if (wIstr & (0x0800) & wInterrupt_Mask)
  {
    ...
    (*((volatile unsigned *)((0x40005C00L) + 0x44)) = (uint16_t)(uint16_t)(~(0x0800)));
  ...
  if (wIstr & (0x0100) & wInterrupt_Mask)
  {
    ...
    (*((volatile unsigned *)((0x40005C00L) + 0x44)) = (uint16_t)(uint16_t)(~(0x0100)));
    
    if ((((uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x48)))&(0x8000))!=0)
    {
       
      esof_counter ++;
      
       
      if ((esof_counter >3)&&((((uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x40)))&(0x0008))==0))
      {           
         
      
         
        wCNTR = ((uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x40))); 
      
         
        for (i=0;i<8;i++) EP[i] = ((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + i)));
        ...
        while((((uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x44)))&(0x0400)) == 0);
