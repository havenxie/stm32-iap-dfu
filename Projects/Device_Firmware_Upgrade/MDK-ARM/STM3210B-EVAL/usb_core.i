...
#line 31 "..\\..\\..\\Libraries\\STM32_USB-FS-Device_Driver\\src\\usb_core.c"
 
 
#line 39 "..\\..\\..\\Libraries\\STM32_USB-FS-Device_Driver\\src\\usb_core.c"
...
uint8_t *Standard_GetStatus(uint16_t Length)
{
  ...
  else if ((pInformation->USBbmRequestType & (0x60 | 0x1F)) == (0x00 | ENDPOINT_RECIPIENT))
  {
    ...
    if ((wIndex0 & (1 << 7)))
    {
      ...
      if ((((uint16_t)((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & (0x0030)) == (0x0010)))
      {
        (StatusInfo . bw . bb1 |= (1 << 0));  
      }
    }
    else
    {
      ...
      if ((((uint16_t)((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & (0x3000)) == (0x1000)))
      {
        (StatusInfo . bw . bb1 |= (1 << 0));  
      }
    }
...
RESULT Standard_ClearFeature(void)
{
  ...
  { 
    ...
    if ((pInformation->USBwIndexs . bw . bb0 & (1 << 7)))
    {
      ...
      Status = ((uint16_t)((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & (0x0030));
    }
    else
    {
      Status = ((uint16_t)((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & (0x3000));
    }
    ...
    else
    {
      ...
      if ((((uint16_t)((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & (0x3000)) == (0x1000)))
      {
        if (Related_Endpoint == ((uint8_t)0))
        {
          ...
          { register uint16_t _wRegVal; _wRegVal = ((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & ((0x3000)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))); if(((0x1000) & (0x3000))!= 0) _wRegVal ^= (0x1000); if(((0x2000) & (0x3000))!= 0) _wRegVal ^= (0x2000); (*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint)= (uint16_t)(_wRegVal | (0x8000)|(0x0080))); };
        }
        else
        {
...
RESULT Standard_SetEndPointFeature(void)
{
  ...
  else
  {
    if (wIndex0 & 0x80)
    {
      ...
      { register uint16_t _wRegVal; _wRegVal = ((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & ((0x0030)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))); if(((0x0010) & (0x0010))!= 0) _wRegVal ^= (0x0010); if(((0x0020) & (0x0010))!= 0) _wRegVal ^= (0x0020); (*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint)= (uint16_t)(_wRegVal | (0x8000)|(0x0080))); };
    }

    else
    {
       
      { register uint16_t _wRegVal; _wRegVal = ((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint))) & ((0x3000)|((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))); if(((0x1000) & (0x1000))!= 0) _wRegVal ^= (0x1000); if(((0x2000) & (0x1000))!= 0) _wRegVal ^= (0x2000); (*(((volatile unsigned *)((0x40005C00L))) + Related_Endpoint)= (uint16_t)(_wRegVal | (0x8000)|(0x0080))); };
    }
  }
...
void DataStageOut(void)
{
  ...
  else
  {
    ...
    else if (pEPinfo->Usb_wLength == 0)
    {
      ...
      { (*((uint32_t *)((((uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+((uint8_t)0)*8+2)*2 + (0x40006000L))) = 0); (SaveTState = (0x0030)); };
    }
  }
}
...
void NoData_Setup0(void)
{
  ...
  if ((pInformation->USBbmRequestType & (0x60 | 0x1F)) == (0x00 | DEVICE_RECIPIENT))
  {
    ...
    {
      if ((pInformation->USBwValues . bw . bb0 == DEVICE_REMOTE_WAKEUP)           && (pInformation->USBwIndexs . w == 0))
...
uint8_t Setup0_Process(void)
{
  ...
  pBuf.b = (0x40006000L) + (uint8_t *)(((uint16_t)*((uint32_t *)((((uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+((uint8_t)0)*8+4)*2 + (0x40006000L)))) * 2);  
...
void SetDeviceAddress(uint8_t Val)
{
  ...
  for (i = 0; i < nEP; i++)
  {
    (*(((volatile unsigned *)((0x40005C00L))) + (uint8_t)i)= (uint16_t)(0x8000)|(0x0080)|(((uint16_t)(*(((volatile unsigned *)((0x40005C00L))) + (uint8_t)i))) & ((0x8000)|(0x0800)|(0x0600)|(0x0100)|(0x0080)|(0x000F))) | (uint8_t)i);
  }  
