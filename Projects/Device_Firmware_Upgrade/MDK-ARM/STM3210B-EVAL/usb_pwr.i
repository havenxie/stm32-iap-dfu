...
#line 31 "..\\src\\usb_pwr.c"
#line 32 "..\\src\\usb_pwr.c"
...
#line 33 "..\\src\\usb_pwr.c"
#line 34 "..\\src\\usb_pwr.c"
...
void Suspend(void)
{
  ...
  volatile uint32_t savePWR_CR=0;
	...
	if((((uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x44)))&(0x1000))==0)
	{
		__wfi();
...
void Resume_Init(void)
{
  ...
  (*((volatile unsigned *)((0x40005C00L) + 0x40)) = (uint16_t)((0x8000) | (0x1000) | (0x0800) | (0x2000) | (0x0200) | (0x0100) | (0x0400) ));
